...
import fr.pturpin.hackathon.iceandfire.strategy.comparator.move.MoveCommandComparator;
import fr.pturpin.hackathon.iceandfire.strategy.comparator.TowerCommandComparator;
import fr.pturpin.hackathon.iceandfire.strategy.comparator.train.TrainCommandComparator;
...
import fr.pturpin.hackathon.iceandfire.strategy.guard.move.AnyMoveGuard;
import fr.pturpin.hackathon.iceandfire.strategy.guard.move.KeepingTiePositionMoveGuard;
import fr.pturpin.hackathon.iceandfire.strategy.guard.move.MoveGuard;
import fr.pturpin.hackathon.iceandfire.strategy.guard.tower.AnyBuildGuard;
import fr.pturpin.hackathon.iceandfire.strategy.guard.tower.BuildGuard;
import fr.pturpin.hackathon.iceandfire.strategy.guard.tower.NextToFrontLineBuildGuard;
import fr.pturpin.hackathon.iceandfire.strategy.guard.tower.NotNextToTowerGuard;
import fr.pturpin.hackathon.iceandfire.strategy.guard.train.*;
